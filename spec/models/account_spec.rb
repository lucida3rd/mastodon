...
RSpec.describe Account, type: :model do
  ...
  describe 'validations' do
    ...
    context 'when is local' do
      ...
      it 'is invalid if the note is longer than 1200 characters' do
        account = Fabricate.build(:account, note: Faker::Lorem.characters(number: 1201))
        account.valid?
    ...
    context 'when is remote' do
      ...
      it 'is valid even if the note is longer than 1200 characters' do
        account = Fabricate.build(:account, domain: 'domain', note: Faker::Lorem.characters(number: 1201))
        account.valid?
